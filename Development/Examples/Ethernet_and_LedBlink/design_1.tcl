...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set CLK_X5 [ create_bd_port -dir I CLK_X5 ]
  ...
  # Create instance: pps_0, and set properties
  set block_name pps
  set block_cell_name pps_0
  if { [catch {set pps_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pps_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net NOT_GATE_0_a_not [get_bd_ports R_LED] [get_bd_pins NOT_GATE_0/a_not]
  connect_bd_net -net iclk_0_1 [get_bd_ports CLK_X5] [get_bd_pins pps_0/iclk]
  connect_bd_net -net pps_0_pps [get_bd_ports G_LED] [get_bd_pins NOT_GATE_0/a] [get_bd_pins pps_0/pps]
